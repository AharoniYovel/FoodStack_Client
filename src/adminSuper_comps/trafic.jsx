    ...
    <React.Fragment>
      ...
      <ul className="list-group  mx-auto trafic">
        <li className="list-group-item d-flex justify-content-between align-items-center fs-5">
          ...
          <span className="badge bg-danger bg-gradient rounded-pill">
            {empCount}
          </span>
        </li>
        ...
        <li className="list-group-item d-flex justify-content-between align-items-center fs-5">
          <span>
            {<PlaceIcon className="fs-2" />} Points Waiting for grouping
          </span>
          <span className="badge bg-secondary  rounded-pill">{pointCount}</span>
        </li>

        <li className="list-group-item d-flex justify-content-between align-items-center fs-5">
          <span>{<ForkLeftIcon className="fs-2" />} Active Path </span>
